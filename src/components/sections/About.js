    ...
    return(
        ...
        { loading ? 
            ...
            <section className="aboutSection">
                <p>
                    I am a full stack web developer with a good eye. I've always had a love for design and user experience. In my 8 years of teaching, this applied to how I operated my classroom. In web development, I've found that this not only applies to UX but also the code itself and how its structured and written.
                </p>
                <p>
